...
```
wget --no-check-certificate -O snell.sh https://raw.githubusercontent.com/glsname/snell.sh/master/snell.sh
chmod +x snell.sh
./snell.sh
```
...
```
wget --no-check-certificate -O snell.sh https://raw.githubusercontent.com/glsname/snell.sh/master/snell.centos.sh
chmod +x snell.sh
./snell.sh
```
